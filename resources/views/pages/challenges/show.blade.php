...
@section('content')
    ...
    <div class="container-fluid no-padding-container no-margin-container">
        ...
        <div class="container-fluid no-margin-container no-margin-container" style="background: url('images/ballon.jpg') center no-repeat; background-size: cover;background-attachment: fixed;">
